...
echo
echo "Running FCFS simulation with $TASKS Tasks on Seed: $SEED"
...
gnuplot -persist <<-EOFMarker
	...
	set title "First Come First Serve- #Tasks: $TASKS, Seed: $SEED" font "Courier Bold,12"
...
# echo
# echo "Running SJF simulation with $TASKS Tasks on Seed: $SEED"

# ./simgen $TASKS $SEED | ./sjfsim --quantum 0 --dispatch 0 > results/q50_d0.txt
# ./simgen $TASKS $SEED | ./sjfsim --quantum 0 --dispatch 5 > results/q50_d5.txt
# ./simgen $TASKS $SEED | ./sjfsim --quantum 0 --dispatch 10 > results/q50_d10.txt
# ./simgen $TASKS $SEED | ./sjfsim --quantum 0 --dispatch 15 > results/q50_d15.txt
# ./simgen $TASKS $SEED | ./sjfsim --quantum 0 --dispatch 20 > results/q50_d20.txt
# ./simgen $TASKS $SEED | ./sjfsim --quantum 0 --dispatch 25 > results/q50_d25.txt
...
# 	set terminal pdf
# 	set output 'graphs/graph_waiting_sjf.pdf'

# 	set title "Shortest Job First- #Tasks: $TASKS, Seed: $SEED" font "Courier Bold,12"
# 	set xlabel "Dispatch Overhead (ticks)" font "Courier Bold,"
# 	set ylabel "Average Waiting Time (ticks)" font "Courier Bold,"
	
# 	plot $R1 u 1:2 with lp title 'q=N/A'  

# 	set output 'graphs/graph_turnaround_sjf.pdf'
# 	set ylabel "Average Turn Around Time (ticks)" font "Courier Bold,"
# 	plot $R1 u 1:2 with lp title 'q=N/A
